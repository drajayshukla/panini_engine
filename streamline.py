...
def restore_print_history():
    logger_path = Path("engine_main.py")
...
class PrakriyaLogger:
    ...
    def print_history(self):
        ...
        print("=======================================\n")
'''
    logger_path.write_text(code, encoding='utf-8')
    print("✅ System Core: 'PrakriyaLogger.print_history' restored.")


if __name__ == "__main__":
    restore_print_history()