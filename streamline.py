"""
FILE: restore_stability.py
PURPOSE: Re-write the UI with a SAFE HTML generator function to prevent broken layouts.
"""
import os
import sys
...
print("🚀 UI Stabilized. Clean layout applied. Refresh the app now.")