"""
FILE: enforce_pratipadika_strict.py
PURPOSE: Enforce Sutra 1.2.45 strictly.
LOGIC: Reject input if it exists in a known list of Dhatus or Pratyayas.
"""
import os
import sys
import subprocess
...
# ==============================================================================
# LOGIC: SUBANTA PROCESSOR (With Strict 1.2.45 Guards)
# ==============================================================================
NEW_PROCESSOR_CODE = '''"""
...
with open("logic/subanta_processor.py", "w", encoding="utf-8") as f: f.write(NEW_PROCESSOR_CODE)
with open("tests/test_validation_1_2_45.py", "w", encoding="utf-8") as f: f.write(TEST_VALIDATION_CODE)

print("🚀 Strict Validation (1.2.45) Implemented. Running rejection tests...")
subprocess.run([sys.executable, "tests/test_validation_1_2_45.py"])