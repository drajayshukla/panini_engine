"""
FILE: fix_logger_attribute_error.py
PURPOSE: Restore 'print_history' method in PrakriyaLogger.
         Fixes AttributeError causing 35 test crashes.
"""
import os
import sys
import subprocess
...
# ==============================================================================
# ENGINE MAIN: PRAKRIYA LOGGER (Restored & Enriched)
# ==============================================================================
LOGGER_CODE = '''"""
FILE: engine_main.py
...
print("🚀 Logger Fixed (print_history restored). Running Tests...")
