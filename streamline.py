"""
FILE: fix_ui_glitch.py
PURPOSE: Fix the HTML string slicing bug in the UI to prevent broken tags.
"""
import os
import sys
        ...
        for i, step in enumerate(history):
            ...
            <div class="step-card">
                <div style="display:flex; justify-content:space-between;">
                    ...
                    <span style="color:#bdc3c7; font-size:0.8rem;">चरण {i+1}</span>
                </div>
...
print("🚀 UI Glitch Fixed. Please Refresh (R) the Streamlit App.")