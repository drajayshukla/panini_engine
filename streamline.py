...
def deploy_siddhanta_ui():
    page_path = Path("pages/1_🔍_Declension_Engine.py")
    
    # This code includes the traditional Siddhanta rendering logic
...
'''
    ...
    print("✅ Deployed Siddhanta UI to pages/1_🔍_Declension_Engine.py")
