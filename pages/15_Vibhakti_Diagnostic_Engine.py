...
LOGIC_RULES = {
    "प्रथमा एकवचन": [
        "ः", "न्", "म्", "ा", "ी", "ू", "ऋ", "क्", "ट्", "प्", "त्",
        "ाः", "व", "ा", "ह"                # संबोधन और विशेष व्यञ्जनान्त (उदा. राजा, पिता)
    ],
    "प्रथमा द्विवचन": [
        "औ", "ौ", "ए", "े", "ई", "ी",      # आपके मूल नियम
        "नी", "णी"                         # नपुंसकलिङ्ग द्विवचन (उदा. फले, वारिणी)
    ],
    "प्रथमा बहुवचन": [
        "ाः", "यः", "वः", "णि", "सि",      # आपके मूल नियम
        "अः", "हः", "धः", "शः", "तः", "नः",
        "य", "ए", "ा"                      # सर्वनाम और नपुंसकलिङ्ग (उदा. ते, सर्वाणि)
    ],
    "द्वितीया बहुवचन": [
        "आन्", "ईन्", "ून्", "ॄन्", "ः",    # आपके मूल नियम
        "ईः", "ऊः", "अः", "ाः",
        "ानि", "ाणि"                       # नपुंसकलिङ्ग द्वितीया बहुवचन
    ],
    "तृतीया एकवचन": [
        "एण", "णा", "ना", "या", "त्रा", "सा", "वा", "ा", "ता", "धा", "भा",
        "या", "ना", "इना"                  # (उदा. मत्या, वारिणा, हरिणा)
    ],
    "चतुर्थी एकवचन": [
        "आय", "ये", "वे", "त्रे", "यै", "स्मै", "भ्यम्", "ते", "ने", "से", "ए",
        "ने", "ये", "ए"                    # (उदा. आत्मने, हरये, मरुते)
    ],
    "षष्ठी एकवचन": [
        "स्य", "अः", "ओः", "आः", "याः", "तुः", "सः", "तः", "नः", "चः", "जः",
        "षः", "हः", "शः"                   # व्यञ्जनान्त विशिष्ट (उदा. वाचः, दिपः)
    ],
    "सप्तमी एकवचन": [
        "ए", "औ", "रि", "ति", "नि", "वि", "यि", "याम्", "वाम्", "इ", "षि", "धि",
        "स्मिन्", "आम्", "ौ"               # सर्वनाम और आकारान्त (उदा. सर्वस्मिन्, रमायाम्, मत्याम्)
    ]
}
