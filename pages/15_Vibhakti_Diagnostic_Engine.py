...
# --- ३. मास्टर लॉजिक एवं क्रम (Robust Rules) ---
LOGIC_RULES = {
...
def main():
    ...
    st.caption("विभक्ति क्रमानुसार संतुलित प्रदर्शन (Max 50 results) | केवल व्याकरणिक विश्लेषण")
    ...
    for entry in data:
        ...
        # प्रथमा एकवचन को संदर्भ के लिए अलग रखा गया है
        prathama_ek = raw_forms[0]
                ...
                if sanskrit_match(roop, p):
                    if selected_symptom == "--सभी दिखाएं--" or sanskrit_match(roop, selected_symptom):
                        matches.append({
                            ...
                            "शब्द": entry.get("word"),
                            "प्रथमा एक.": prathama_ek,  # नया कॉलम
                            "विभक्ति": vibhakti,
                            "रूप": roop,
                            "लक्षण": p
                        })
    ...
    if matches:
        ...
        # 'प्रथमा एक.' कॉलम को 'विभक्ति' के ठीक पहले दिखाया गया है
        st.table(df[["शब्द", "प्रथमा एक.", "विभक्ति", "रूप", "लक्षण"]])
