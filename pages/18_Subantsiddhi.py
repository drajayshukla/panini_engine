...
if word_input:
    # --- STEP 1: AUTOMATIC VERIFICATION (1.2.45 / 1.2.46) ---
    ...
    if base_info['is_pratipadika']:
        ...
        if is_pada:
            ...
            if intermediate_word.endswith('स्'):
                ...
                # Step 5c: Visarga (8.3.15) -> Result: रामः
        ...
        # Rejection Logic for Dhatus or non-Pratipadikas
