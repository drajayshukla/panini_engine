...
st.caption("एक ही धातु के विभिन्न 'कर्तरि' रूपों के बीच सूक्ष्म अंतर को पहचानें")
...
# --- ३. देवनागरी मैपिंग (Updated with 'कर्तरि') ---
lakara_labels = {
...
def get_grammatical_rule(lak_code, pur, vac):
    ...
    rules = {
        ...
        "plung": "कर्तरि लुङ्। 'अ' उपसर्ग + 'सिच/अ' विकरण।",
    }
...
# --- ५. क्विज लॉजिक इंजन (Single Dhatu Mode) ---
...
if db_meta and db_roopa:
    ...
    if st.session_state.q:
        ...
        if st.session_state.answered:
            ...
            st.divider()
            st.subheader(f"📊 '{q['dhatu']}' ({q['lakara']}) कर्तरि मैट्रिक्स")
